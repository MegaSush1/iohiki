...
ALTER TABLE clients
ADD CONSTRAINT FK_clients_uid FOREIGN KEY (UID) REFERENCES UID(UID);
...
ADD CONSTRAINT FK_artistes_uid FOREIGN KEY (UID) REFERENCES UID(UID);
...
ALTER TABLE albums
ADD ( CONSTRAINT FK_albums_uid FOREIGN KEY (UID) REFERENCES UID(UID),
...
ALTER TABLE songs
ADD (CONSTRAINT FK_songs_uid FOREIGN KEY (UID) REFERENCES UID(UID),
...
ADD (CONSTRAINT FK_podcasts_uid FOREIGN KEY (UID) REFERENCES UID(UID),
...
ADD (CONSTRAINT FK_episodes_uid FOREIGN KEY (UID) REFERENCES UID(UID),
